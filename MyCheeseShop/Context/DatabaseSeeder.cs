    ...
    public class DatabaseSeeder
    {
        ...
        private List<Cheese> GetCheeses()
        {
            ...
            [
                ...
                new Cheese { Name = "Monterey Jack Magic", Type = "Semi-Soft", Description = "A versatile American cheese with a mild and buttery taste, great for melting on nachos, sandwiches, or adding to omelets for extra creaminess.", Strength = "Medium", Price = 7.49m, ImageUrl="monterey.png" },
                ...
                new Cheese { Name = "Windows95Man's Cheese", Type = "Fresh", Description = "An absolutely delectable cheese, themed after Windows 95, inspired (and totally sponsored) by the beloved Windows95Man from Finland!", Strength = "Medium", Price = 7.99m, ImageUrl="windows95.png" }
            ];
        }
